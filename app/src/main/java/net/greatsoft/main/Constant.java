...
public class Constant {
	...
	public static String LOCAL_DB = BASE_DIR+"/dbs";//下载的所有数据文件存放的地方
	 ...
	 * 服务项目:家庭 1010
	 */
	public static final String SERVICE_ITEM_1010 = "1010";
	/**
	 * 服务项目:儿童花名册 2009
	 */
	...
	public static List<Checks> getMedicineNum() {
		List<Checks> list = new ArrayList<>();
		list.add(new Checks(null, "每日一次", "每日一次", null, null, null));
		list.add(new Checks(null, "每日两次", "每日两次", null, null, null));
		list.add(new Checks(null, "每日三次", "每日三次", null, null, null));
		list.add(new Checks(null, "两日一次", "两日一次", null, null, null));
		list.add(new Checks(null, "每周一次", "每周一次", null, null, null));
		list.add(new Checks(null, "隔日一次", "隔日一次", null, null, null));
		return list;
	}
	...
	public static List<Checks> getMedicineUnit() {
		List<Checks> list = new ArrayList<>();
		list.add(new Checks(null, "1", "mg", null, null, null));
		list.add(new Checks(null, "2", "g", null, null, null));
		list.add(new Checks(null, "3", "片", null, null, null));
		list.add(new Checks(null, "4", "U", null, null, null));
		list.add(new Checks(null, "5", "粒", null, null, null));
		list.add(new Checks(null, "6", "丸", null, null, null));
		list.add(new Checks(null, "7", "ml", null, null, null));
		return list;
	}
	...
	public static List<Checks> getDiabetesInfoComp() {
		List<Checks> list = new ArrayList<>();
		list.add(new Checks(null, "1", "冠心病", null, null, null));
		list.add(new Checks(null, "2", "高血压", null, null, null));
		list.add(new Checks(null, "3", "高血脂", null, null, null));
		list.add(new Checks(null, "4", "视网膜病变", null, null, null));
		list.add(new Checks(null, "5", "周围神经病变", null, null, null));
		list.add(new Checks(null, "6", "肾病", null, null, null));
		list.add(new Checks(null, "7", "足部病变", null, null, null));
		list.add(new Checks(null, "8", "脑卒中", null, null, null));
		list.add(new Checks(null, "9（心肌梗死）", "冠心病（心肌梗死）", null, null, null));
		return list;
	}
