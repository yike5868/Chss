...
/**
 * @author HS
 * @date 2016年11月12日 下午2:21:52
 * @Description: 听力言语残疾人健康管理随访表
 */
@Entity
public class DisabilityHearing extends Entry {
    /**
     * 听力言语残疾人健康管理随访表ID
     */
    private String disabilityHearingId;
     ...
     * 残疾证号
     */
    private String disabilityHearingNo;

    /**
     * 致残时间
     */
    private Date disabilityHearingDate;
     ...
     * 能听见的环境声
     */
    private String hearEnvironmentCode;

    /**
     * 能听见的言语声
     */
    private String hearSpeechCode;
     ...
     * 唇读能力
     */
    private String lipreadingAbility;
    ...
    public String getLipreadingAbility() {
        return this.lipreadingAbility;
    }

    public void setLipreadingAbility(String lipreadingAbility) {
        this.lipreadingAbility = lipreadingAbility;
    }
    ...
    public String getHearSpeechCode() {
        return this.hearSpeechCode;
    }

    public void setHearSpeechCode(String hearSpeechCode) {
        this.hearSpeechCode = hearSpeechCode;
    }

    public String getHearEnvironmentCode() {
        return this.hearEnvironmentCode;
    }

    public void setHearEnvironmentCode(String hearEnvironmentCode) {
        this.hearEnvironmentCode = hearEnvironmentCode;
    }
    ...
    public Date getDisabilityHearingDate() {
        return this.disabilityHearingDate;
    }

    public void setDisabilityHearingDate(Date disabilityHearingDate) {
        this.disabilityHearingDate = disabilityHearingDate;
    }

    public String getDisabilityHearingNo() {
        return this.disabilityHearingNo;
    }

    public void setDisabilityHearingNo(String disabilityHearingNo) {
        this.disabilityHearingNo = disabilityHearingNo;
    }
    ...
    public String getDisabilityHearingId() {
        return this.disabilityHearingId;
    }

    public void setDisabilityHearingId(String disabilityHearingId) {
        this.disabilityHearingId = disabilityHearingId;
    }

    @Generated(hash = 980955739)
    public DisabilityHearing(String disabilityHearingId, String personInfoId,
                             String manageOrgId, String disabilityHearingNo, Date disabilityHearingDate,
                             ...
                             String laborAbility, String laborSkill, String hearEnvironmentCode,
                             String hearSpeechCode, String languageAbility, String lipreadingAbility,
    ...
    @Generated(hash = 127631618)
    @Keep
    public DisabilityHearing() {
