...
@Entity
public class DisabilityIntelligence extends Entry {
    /**
     * 智力残疾人健康管理随访表ID
     */
    private String disabilityIntelligenceId;
     ...
     * 残疾证号
     */
    private String disabilityIntelligenceNo;

    /**
     * 致残时间
     */
    private Date disabilityIntelligenceDate;
    ...
    public Date getDisabilityIntelligenceDate() {
        return this.disabilityIntelligenceDate;
    }

    public void setDisabilityIntelligenceDate(Date disabilityIntelligenceDate) {
        this.disabilityIntelligenceDate = disabilityIntelligenceDate;
    }

    public String getDisabilityIntelligenceNo() {
        return this.disabilityIntelligenceNo;
    }

    public void setDisabilityIntelligenceNo(String disabilityIntelligenceNo) {
        this.disabilityIntelligenceNo = disabilityIntelligenceNo;
    }
    ...
    public String getDisabilityIntelligenceId() {
        return this.disabilityIntelligenceId;
    }

    public void setDisabilityIntelligenceId(String disabilityIntelligenceId) {
        this.disabilityIntelligenceId = disabilityIntelligenceId;
    }

    @Generated(hash = 375358568)
    public DisabilityIntelligence(String disabilityIntelligenceId,
                                  String personInfoId, String manageOrgId, String disabilityIntelligenceNo,
                                  Date disabilityIntelligenceDate, String disabilityReasonCode,
                                  String disabilityReasonValue, String disabilityGrade,
                                  String durationTimeCode, String selfCareAssessCode, String guardianName,
                                  String guardianTelNo, String educationBlindCode, String educationBlindValue,
                                  String educationDeafCode, String educationDeafValue,
                                  String educationOtherCode, String educationOtherValue, String employmentCode,
                                  String employmentValue, String workUnit, String workUnitTel,
                                  String averageIncome, String laborAbility, String laborSkill, String iq,
                                  String symptom, String rehabilitation, String rehabilitationNeeds,
                                  Date nextFollowupDate, Date followupDate, String followupDoctorId,
                                  ...
                                  String modifier, Date modifiedTime, Integer assessmentCount,
    ...
    @Generated(hash = 1586079351)
    @Keep
    public DisabilityIntelligence() {
