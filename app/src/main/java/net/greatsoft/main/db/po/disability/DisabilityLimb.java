 ...
 *
 * @author HS
 * @date 2016年11月12日 下午1:03:14
 * @Description: 肢体残疾人健康管理随访表
 *
 */
@Entity
public class DisabilityLimb extends Entry {
	/**
	 * 肢体残疾人健康管理随访表
	 */
	private String disabilityLimbId;
	 ...
	 * 残疾证号
	 */
	private String disabilityLimbNo;

	/**
	 * 致残时间
	 */
	private Date disabilityLimbDate;
	...
	public void setDisabilitySite(String disabilitySite) {
		this.disabilitySite = disabilitySite;
	}
	...
	public Date getDisabilityLimbDate() {
		return this.disabilityLimbDate;
	}

	public void setDisabilityLimbDate(Date disabilityLimbDate) {
		this.disabilityLimbDate = disabilityLimbDate;
	}

	public String getDisabilityLimbNo() {
		return this.disabilityLimbNo;
	}

	public void setDisabilityLimbNo(String disabilityLimbNo) {
		this.disabilityLimbNo = disabilityLimbNo;
	}
	...
	public String getDisabilityLimbId() {
		return this.disabilityLimbId;
	}

	public void setDisabilityLimbId(String disabilityLimbId) {
		this.disabilityLimbId = disabilityLimbId;
	}

	@Generated(hash = 446348127)
	public DisabilityLimb(String disabilityLimbId, String personInfoId,
			String manageOrgId, String disabilityLimbNo, Date disabilityLimbDate,
			...
			String laborAbility, String laborSkill, String disabilitySite,
	...
	@Generated(hash = 1175171847)
    @Keep
	public DisabilityLimb() {
