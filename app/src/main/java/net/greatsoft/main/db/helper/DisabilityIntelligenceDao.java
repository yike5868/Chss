...
/** 
 * DAO for table "DISABILITY_INTELLIGENCE".
*/
public class DisabilityIntelligenceDao extends AbstractDao<DisabilityIntelligence, Void> {

    public static final String TABLENAME = "DISABILITY_INTELLIGENCE";

    /**
     * Properties of entity DisabilityIntelligence.<br/>
     * Can be used for QueryBuilder and for referencing column names.
    */
    public static class Properties {
        public final static Property DisabilityIntelligenceId = new Property(0, String.class, "disabilityIntelligenceId", false, "DISABILITY_INTELLIGENCE_ID");
        ...
        public final static Property DisabilityIntelligenceNo = new Property(3, String.class, "disabilityIntelligenceNo", false, "DISABILITY_INTELLIGENCE_NO");
        public final static Property DisabilityIntelligenceDate = new Property(4, java.util.Date.class, "disabilityIntelligenceDate", false, "DISABILITY_INTELLIGENCE_DATE");
        ...
        public final static Property Iq = new Property(25, String.class, "iq", false, "IQ");
        public final static Property Symptom = new Property(26, String.class, "symptom", false, "SYMPTOM");
        public final static Property Rehabilitation = new Property(27, String.class, "rehabilitation", false, "REHABILITATION");
        public final static Property RehabilitationNeeds = new Property(28, String.class, "rehabilitationNeeds", false, "REHABILITATION_NEEDS");
        public final static Property NextFollowupDate = new Property(29, java.util.Date.class, "nextFollowupDate", false, "NEXT_FOLLOWUP_DATE");
        public final static Property FollowupDate = new Property(30, java.util.Date.class, "followupDate", false, "FOLLOWUP_DATE");
        public final static Property FollowupDoctorId = new Property(31, String.class, "followupDoctorId", false, "FOLLOWUP_DOCTOR_ID");
        public final static Property FollowupDoctorName = new Property(32, String.class, "followupDoctorName", false, "FOLLOWUP_DOCTOR_NAME");
        ...
        public final static Property AssessmentCount = new Property(44, Integer.class, "assessmentCount", false, "ASSESSMENT_COUNT");
        public final static Property MissingCount = new Property(45, Integer.class, "missingCount", false, "MISSING_COUNT");
        public final static Property IntactRate = new Property(46, Double.class, "intactRate", false, "INTACT_RATE");
    };


    public DisabilityIntelligenceDao(DaoConfig config) {
        super(config);
    }
    
    public DisabilityIntelligenceDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DISABILITY_INTELLIGENCE\" (" + //
                "\"DISABILITY_INTELLIGENCE_ID\" TEXT," + // 0: disabilityIntelligenceId
                "\"PERSON_INFO_ID\" TEXT," + // 1: personInfoId
                "\"MANAGE_ORG_ID\" TEXT," + // 2: manageOrgId
                "\"DISABILITY_INTELLIGENCE_NO\" TEXT," + // 3: disabilityIntelligenceNo
                "\"DISABILITY_INTELLIGENCE_DATE\" INTEGER," + // 4: disabilityIntelligenceDate
                ...
                "\"IQ\" TEXT," + // 25: iq
                "\"SYMPTOM\" TEXT," + // 26: symptom
                "\"REHABILITATION\" TEXT," + // 27: rehabilitation
                "\"REHABILITATION_NEEDS\" TEXT," + // 28: rehabilitationNeeds
                "\"NEXT_FOLLOWUP_DATE\" INTEGER," + // 29: nextFollowupDate
                "\"FOLLOWUP_DATE\" INTEGER," + // 30: followupDate
                "\"FOLLOWUP_DOCTOR_ID\" TEXT," + // 31: followupDoctorId
                "\"FOLLOWUP_DOCTOR_NAME\" TEXT," + // 32: followupDoctorName
                ...
                "\"ASSESSMENT_COUNT\" INTEGER," + // 44: assessmentCount
                "\"MISSING_COUNT\" INTEGER," + // 45: missingCount
                "\"INTACT_RATE\" REAL);"); // 46: intactRate
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DISABILITY_INTELLIGENCE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DisabilityIntelligence entity) {
        stmt.clearBindings();
 
        String disabilityIntelligenceId = entity.getDisabilityIntelligenceId();
        if (disabilityIntelligenceId != null) {
            stmt.bindString(1, disabilityIntelligenceId);
        }
        ...
        String disabilityIntelligenceNo = entity.getDisabilityIntelligenceNo();
        if (disabilityIntelligenceNo != null) {
            stmt.bindString(4, disabilityIntelligenceNo);
        }
 
        java.util.Date disabilityIntelligenceDate = entity.getDisabilityIntelligenceDate();
        if (disabilityIntelligenceDate != null) {
            stmt.bindLong(5, disabilityIntelligenceDate.getTime());
        }
        ...
        if (assessmentCount != null) {
            stmt.bindLong(45, assessmentCount);
        }
 
        Integer missingCount = entity.getMissingCount();
        if (missingCount != null) {
            stmt.bindLong(46, missingCount);
        }
 
        Double intactRate = entity.getIntactRate();
        if (intactRate != null) {
            stmt.bindDouble(47, intactRate);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, DisabilityIntelligence entity) {
        stmt.clearBindings();
    ...
    @Override
    public DisabilityIntelligence readEntity(Cursor cursor, int offset) {
        DisabilityIntelligence entity = new DisabilityIntelligence( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // disabilityIntelligenceId
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // disabilityIntelligenceNo
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)), // disabilityIntelligenceDate
            ...
            cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // iq
            cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26), // symptom
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27), // rehabilitation
            cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28), // rehabilitationNeeds
            cursor.isNull(offset + 29) ? null : new java.util.Date(cursor.getLong(offset + 29)), // nextFollowupDate
            cursor.isNull(offset + 30) ? null : new java.util.Date(cursor.getLong(offset + 30)), // followupDate
            cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31), // followupDoctorId
            cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32), // followupDoctorName
            ...
            cursor.isNull(offset + 44) ? null : cursor.getInt(offset + 44), // assessmentCount
            cursor.isNull(offset + 45) ? null : cursor.getInt(offset + 45), // missingCount
            cursor.isNull(offset + 46) ? null : cursor.getDouble(offset + 46) // intactRate
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, DisabilityIntelligence entity, int offset) {
        entity.setDisabilityIntelligenceId(cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0));
        ...
        entity.setDisabilityIntelligenceNo(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setDisabilityIntelligenceDate(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
        ...
        entity.setIq(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
        entity.setSymptom(cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26));
        entity.setRehabilitation(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
        entity.setRehabilitationNeeds(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
        entity.setNextFollowupDate(cursor.isNull(offset + 29) ? null : new java.util.Date(cursor.getLong(offset + 29)));
        entity.setFollowupDate(cursor.isNull(offset + 30) ? null : new java.util.Date(cursor.getLong(offset + 30)));
        entity.setFollowupDoctorId(cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31));
        entity.setFollowupDoctorName(cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32));
        ...
        entity.setAssessmentCount(cursor.isNull(offset + 44) ? null : cursor.getInt(offset + 44));
        entity.setMissingCount(cursor.isNull(offset + 45) ? null : cursor.getInt(offset + 45));
        entity.setIntactRate(cursor.isNull(offset + 46) ? null : cursor.getDouble(offset + 46));
     }
    
    @Override
    protected final Void updateKeyAfterInsert(DisabilityIntelligence entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(DisabilityIntelligence entity) {
        return null;
    }
