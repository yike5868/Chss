...
public class FuChildHealthExam02Fragment extends FragmentParent {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mModel = lFuUiFrameManager.createFuModel(
                FuUiFrameManager.FU_CHILD_HEALTH_EXAM_02, getActivity(),
                new OnEventClick());

        ((FuChildHealthExam02View) mModel).setData(childHealthExam);
    ...
    public void saveHealthExam() {
        ...
        if (!((FuChildHealthExam02View) mModel).saveData(childHealthExam))
            return;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MyTask.SAVE_CHILD_HEALTH_EXAM:
                    savePics(childHealthExam.getChildHealthExamId(), Constant.SERVICE_ITEM_2005, file);
                    break;
                case MyTask.ERROR:
                    ToastUtil.showToast(getContext(), msg.obj.toString(), Toast.LENGTH_SHORT);
                    break;
