 ...
 */
public class FuSSlView extends FuUiFrameModel implements View.OnClickListener {
    ExpandableListView elv_person;
    ExpandableAdapter ea;
    public FuSSlView(Context cxt, FuEventCallBack callBack) {
        super(cxt, callBack);
    }
