 ...
 */
public class FuSExamView extends FuUiFrameModel implements View.OnClickListener {

    ExpandableListView elv_person;
    ExpandableAdapter ea;

    public FuSExamView(Context cxt, FuEventCallBack callBack) {
        super(cxt, callBack);
    }
