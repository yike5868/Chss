...
public class NavigationMenu extends LinearLayout {
	...
	public void setCurrentBtnState(int action) {
		...
		// case FuUiFrameManager.FU_MAIN_COMM:
		//
		// ImageView lCommBp = (ImageView) mNavigation
		// .findViewById(R.id.ic_fu_communion);
		// lCommBp.setImageResource(R.drawable.ic_select_chat);
		//
		// TextView lCommTv = (TextView) mNavigation
		// .findViewById(R.id.tv_fu_communion);
		// lCommTv.setTextColor(mContext.getResources().getColor(
		// R.color.bg_withe));
		//
		// break;

		// case FuUiFrameManager.FU_MAIN_JY:
		//
		// ImageView ljyBp = (ImageView) mNavigation
		// .findViewById(R.id.ic_fu_jy);
		// ljyBp.setImageResource(R.drawable.ic_jy_select);
